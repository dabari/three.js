...
(function() {
	...
	THREE.TransformControls = function(camera, domElement) {
		...
		this.attach = function(object, objectCenter) {
			if (typeof objectCenter !== "undefined") {
				this.useObjectCenter = objectCenter;
			} else {
		...
		this.update = function() {
			...
			if (scope.useObjectCenter === true) {
				worldPosition.copy(
					new THREE.Box3()
						.setFromObject(this.object)
